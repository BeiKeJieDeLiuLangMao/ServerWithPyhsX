...
PxToolkit_debug_common_cflags  += -m32
PxToolkit_debug_common_cflags  += -Werror -m32 -fPIC -msse2 -mfpmath=sse -malign-double -ffast-math -fno-exceptions -fno-rtti -fvisibility=hidden -fvisibility-inlines-hidden
...
PxToolkit_debug_bin      := ./../../PxToolkit/lib/linux32/libPxToolkitDEBUG.a
...
$(PxToolkit_debug_bin): $(PxToolkit_debug_obj) 
	mkdir -p `dirname ./../../PxToolkit/lib/linux32/libPxToolkitDEBUG.a`
...
PxToolkit_checked_common_cflags  += -m32
PxToolkit_checked_common_cflags  += -Werror -m32 -fPIC -msse2 -mfpmath=sse -malign-double -ffast-math -fno-exceptions -fno-rtti -fvisibility=hidden -fvisibility-inlines-hidden
...
PxToolkit_checked_bin      := ./../../PxToolkit/lib/linux32/libPxToolkitCHECKED.a
...
$(PxToolkit_checked_bin): $(PxToolkit_checked_obj) 
	mkdir -p `dirname ./../../PxToolkit/lib/linux32/libPxToolkitCHECKED.a`
...
PxToolkit_profile_common_cflags  += -m32
PxToolkit_profile_common_cflags  += -Werror -m32 -fPIC -msse2 -mfpmath=sse -malign-double -ffast-math -fno-exceptions -fno-rtti -fvisibility=hidden -fvisibility-inlines-hidden
...
PxToolkit_profile_bin      := ./../../PxToolkit/lib/linux32/libPxToolkitPROFILE.a
...
$(PxToolkit_profile_bin): $(PxToolkit_profile_obj) 
	mkdir -p `dirname ./../../PxToolkit/lib/linux32/libPxToolkitPROFILE.a`
...
PxToolkit_release_common_cflags  += -m32
PxToolkit_release_common_cflags  += -Werror -m32 -fPIC -msse2 -mfpmath=sse -malign-double -ffast-math -fno-exceptions -fno-rtti -fvisibility=hidden -fvisibility-inlines-hidden
...
PxToolkit_release_bin      := ./../../PxToolkit/lib/linux32/libPxToolkit.a
...
$(PxToolkit_release_bin): $(PxToolkit_release_obj) 
	mkdir -p `dirname ./../../PxToolkit/lib/linux32/libPxToolkit.a`
