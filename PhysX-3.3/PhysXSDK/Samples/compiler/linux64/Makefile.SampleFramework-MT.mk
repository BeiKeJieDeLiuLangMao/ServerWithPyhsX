...
SampleFramework-MT_debug_common_cflags  += -m64
SampleFramework-MT_debug_common_cflags  += -Werror -m64 -fPIC -msse2 -mfpmath=sse -ffast-math -fno-exceptions -fno-rtti -fvisibility=hidden -fvisibility-inlines-hidden
...
SampleFramework-MT_debug_lflags  += -m64
...
SampleFramework-MT_debug_bin      := ./../../SampleFramework/framework/lib/linux64/libSampleFramework-MTDEBUG.a
...
$(SampleFramework-MT_debug_bin): $(SampleFramework-MT_debug_obj) 
	mkdir -p `dirname ./../../SampleFramework/framework/lib/linux64/libSampleFramework-MTDEBUG.a`
...
SampleFramework-MT_release_common_cflags  += -m64
SampleFramework-MT_release_common_cflags  += -Werror -m64 -fPIC -msse2 -mfpmath=sse -ffast-math -fno-exceptions -fno-rtti -fvisibility=hidden -fvisibility-inlines-hidden
...
SampleFramework-MT_release_lflags  += -m64
...
SampleFramework-MT_release_bin      := ./../../SampleFramework/framework/lib/linux64/libSampleFramework-MT.a
...
$(SampleFramework-MT_release_bin): $(SampleFramework-MT_release_obj) 
	mkdir -p `dirname ./../../SampleFramework/framework/lib/linux64/libSampleFramework-MT.a`
...
SampleFramework-MT_checked_common_cflags  += -m64
SampleFramework-MT_checked_common_cflags  += -Werror -m64 -fPIC -msse2 -mfpmath=sse -ffast-math -fno-exceptions -fno-rtti -fvisibility=hidden -fvisibility-inlines-hidden
...
SampleFramework-MT_checked_lflags  += -m64
...
SampleFramework-MT_checked_bin      := ./../../SampleFramework/framework/lib/linux64/libSampleFramework-MTCHECKED.a
...
$(SampleFramework-MT_checked_bin): $(SampleFramework-MT_checked_obj) 
	mkdir -p `dirname ./../../SampleFramework/framework/lib/linux64/libSampleFramework-MTCHECKED.a`
...
SampleFramework-MT_profile_common_cflags  += -m64
SampleFramework-MT_profile_common_cflags  += -Werror -m64 -fPIC -msse2 -mfpmath=sse -ffast-math -fno-exceptions -fno-rtti -fvisibility=hidden -fvisibility-inlines-hidden
...
SampleFramework-MT_profile_lflags  += -m64
...
SampleFramework-MT_profile_bin      := ./../../SampleFramework/framework/lib/linux64/libSampleFramework-MTPROFILE.a
...
$(SampleFramework-MT_profile_bin): $(SampleFramework-MT_profile_obj) 
	mkdir -p `dirname ./../../SampleFramework/framework/lib/linux64/libSampleFramework-MTPROFILE.a`
